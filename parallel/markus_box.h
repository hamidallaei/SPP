...
public:
	...
	void Init(Node* input_node, Real input_density, Real mu_plus, Real mu_minus, Real D_phi); // Intialize the box, positioning particles, giving them velocities, updating cells and sending
...
void Box::Init(Node* input_node, Real input_density, Real mu_plus, Real mu_minus, Real D_phi)
{
	...
	Real noise_amplitude = sqrt(2*D_phi);
	...
	MarkusParticle::D_phi = D_phi;
	MarkusParticle::mu_plus = mu_plus;
	MarkusParticle::mu_minus = mu_minus;
